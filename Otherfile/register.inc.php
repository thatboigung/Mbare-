...
if(empty($errorMsg)){
    ...
    if($select->rowCount()>0){
      ...
      $insert=$pdo->prepare("INSERT INTO users(name,surname,username,email,phone,password,created,descc,city,street)
      VALUES(:name,:surname,:username,:email,:phone,:password,:created,:descc,:city,:street)");
      if(
        $insert->execute(
          [
            ':name'=>$name,
